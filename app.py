...
import streamlit as st
st.set_page_config(page_title="CAREER BLUES FIGHTER")
...
def main():
    ...
    def inpenc(tok,df,c):
        ...
        padded = pad_sequences(enc, maxlen=15, padding='post')
        return padded
    ...
    qvals = {"Select an Option": 0, "Strongly Agree": 5, "Agree": 4, "Neutral": 3, "Disagree": 2,
             "Strongly Disagree": 1}
    st.title("Career Blues Fighter")
    banner=Image.open("img/21.png")
    st.image(banner, use_column_width=True)
    st.write("Hi! I'm Career Blues Fighter, your personal career counseling bot. Ask your queries in the text box below and hit enter. If and when you are ready to take our personality test, type \"start my test\" and you're good to go!")

    df3 = get_text()
    if (df3.loc[0, 'user']==""):
        ans = "Hi, I'm Career Blues Fighter. \nHow can I help you?"
    ...
    st.text_area("Career Blues Fighter:", value=ans, height=100, max_chars=None)
                                                ...
                                                if (inp8 != "Select an Option"):
                                                    ...
                                                    if (inp9 != "Select an Option"):
                                                        ...
                                                        if (inp10 != "Select an Option"):
                                                            ...
                                                            graph2.add_layout(graph2.legend[1], 'right')
